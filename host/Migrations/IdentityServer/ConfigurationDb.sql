...
CREATE INDEX [IX_ApiResourceProperty_ApiResourceId] ON [ApiResourceProperty] ([ApiResourceId]);
...
CREATE INDEX [IX_IdentityResourceProperty_IdentityResourceId] ON [IdentityResourceProperty] ([IdentityResourceId]);
